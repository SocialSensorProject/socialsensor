...
of $811,683,028$ English tweets. In the context 
...
negotiations the ``Iran Nuclear deal'', and soccer for some (English-speaking)
...
\subfloat[Fig:][Iran Nuclear Deal]{\includegraphics[width=0.33\textwidth]{images/location/world/socialsensor-world-irannucleardeal_location.pdf}}
...
\begin{table}[t!]
\centering
\caption{\label{table:featureStatistics}Feature Statistics of our $811,683,028$ tweet corpus.} % in our Twitter dataset}
...
85,794,831 & 13,607,023 & 46,391,269 & 18,244,772 & 16,212,640 \\ \hline %14,197,509
\multicolumn{5}{c}{} \\
