...
\subfloat[Fig:][Iran Deal]{\includegraphics[width=5.3cm]{images/location/world/socialsensor-world-irannucleardeal_location.eps}}
\subfloat[Fig:][Soccer]{\includegraphics[width=5.3cm]{images/location/world/socialsensor-world-soccer_location.eps}} \\
%\vspace{-10mm}
\subfloat[Fig:][Health Epidemics]{\includegraphics[width=5.3cm]{images/location/states/SocialSensor-us-states-health_epidemics_location.eps}}
...
Table ~\ref{table:featureStatistics} and table ~\ref{table:featureUnique} provide more detail statistics about each feature. For each feature, we reported the unique number of the feature in our dataset, in addition to maximum, average, median values of each feature across the tweets. The second part of the table provides these counts across user dimension meaning that for example a hashtag has been used in average by $10.08$ users. The third part of the table shows the statistics for the hashtag usage of our users e.g., users have used $2$ hashtags in average.
