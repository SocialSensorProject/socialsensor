...
\multirow{5}{*}{\textbf{Sample Hashtags}} & \#usopenchampion                     & \#asteroids                         & \#worldcup                           & \#irandeal                             & {\footnotesize \#gazaunderattack}                           & \#robinwilliams                              & \#policebrutality                          & \#policebrutality                             & \#ebola                                 & \#loveislove                       \\ \cline{2-11} 
                                          & \#novakdjokovic                      & \#astronauts                        & \#lovesoccer                         & \#iranfreedom                          & {\footnotesize \#childrenofsyria}                           & \#ripmandela                                 & \#michaelbrown                             & \#michaelbrown                                & \#virus                                 & \#gaypride                         \\ \cline{2-11} 
                                          ...
                                          & \#tennisnews                         & \#telescope                         & \#beckham                            & \#nuclearpower                         & \#isis                                      & \#paulwalker                                 & \#newnjgunlaw                              & \#newnjgunlaw                                 & \#theplague                             & {\footnotesize \#gaymarriage}                      \\ \hline
\end{tabular}
}
}
...
\caption{Top tweets for each topic from \textit{Logistic Regression} marked with \xmark \; as non-topical, \checkmark \; as a correctly identified topical true positive, and \starmark \; as a correctly identified topical false negative.}
...
\begin{itemize}
\item \checkmark: \; Tweet was topical according to our curated test hashtag set.
\item \starmark:\ \; Tweet was determined to be topical through manual evaluation
...
\item \xmark: \; Tweet was not topical.
\end{itemize}  
...
in Table~\ref{table:results2} would indicate, i.e., many of the highly
ranked tweets are false negatives --- they are actually relevant indicating
that our social sensor learning generalized well beyond the curated hashtag
set in terms of topical relevance.
...
hashtags indicating encouraging generalization properties beyond
the identification of topical hashtags.
