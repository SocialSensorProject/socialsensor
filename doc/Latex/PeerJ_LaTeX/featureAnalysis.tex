...
\begin{figure}[t!]
\centering
\includegraphics[width=0.45\textwidth]{images/avgMI_gray.pdf}%, height=60mm
%\vspace{-3mm}
...
\subfloat[Fig:][]{\includegraphics[width=0.2\textwidth]{images/avgMIBoxPlots/TermVsTopics.pdf}}
\subfloat[Fig:][]{\includegraphics[width=0.2\textwidth]{images/avgMIBoxPlots/LocationVsTopics.pdf}}
\subfloat[Fig:][]{\includegraphics[width=0.2\textwidth]{images/avgMIBoxPlots/HashtagVsTopics.pdf}}
\subfloat[Fig:][]{\includegraphics[width=0.2\textwidth]{images/avgMIBoxPlots/MentionVsTopics.pdf}}
\subfloat[Fig:][]{\includegraphics[width=0.2\textwidth]{images/avgMIBoxPlots/FromVsTopics.pdf}} \\
\end{tabular}
%\vspace{-2mm}
...
\subfloat[Fig:][]{\includegraphics[width=0.19\textwidth]{images/ViolinPlots/From-favoriteCount.eps}}
\subfloat[Fig:][]{\includegraphics[width=0.19\textwidth]{images/ViolinPlots/From-followersCount.eps}}
\subfloat[Fig:][]{\includegraphics[width=0.19\textwidth]{images/ViolinPlots/From-friendsCount.eps}}
\subfloat[Fig:][]{\includegraphics[width=0.19\textwidth]{images/ViolinPlots/From-hashtagCount.eps}}
\subfloat[Fig:][]{\includegraphics[width=0.19\textwidth]{images/ViolinPlots/From-tweetCount.eps}} \\
%\vspace{-10mm}
\subfloat[Fig:][]{\includegraphics[width=0.19\textwidth]{images/ViolinPlots/Hashtag-tweetCount.eps}}
\subfloat[Fig:][]{\includegraphics[width=0.19\textwidth]{images/ViolinPlots/Hashtag-userCount.eps}}
\subfloat[Fig:][]{\includegraphics[width=0.19\textwidth]{images/ViolinPlots/Location-userCount.eps}}
\subfloat[Fig:][]{\includegraphics[width=0.19\textwidth]{images/ViolinPlots/Mention-tweetCount.eps}}
\subfloat[Fig:][]{\includegraphics[width=0.19\textwidth]{images/ViolinPlots/Term-tweetCount.eps}} \\
\end{tabular}
\end{tabular}
%\vspace{-2mm}
...
\subfloat[Fig:][]{\includegraphics[width=0.23\textwidth]{images/DensityPlots_IranDeal/dscatterPlot_From-favoriteCount.eps}} \quad
\subfloat[Fig:][]{\includegraphics[width=0.23\textwidth]{images/DensityPlots_IranDeal/dscatterPlot_From-followersCount.eps}} \quad
\subfloat[Fig:][]{\includegraphics[width=0.23\textwidth]{images/DensityPlots_IranDeal/dscatterPlot_From-friendsCount.eps}} \quad
\subfloat[Fig:][]{\includegraphics[width=0.23\textwidth]{images/DensityPlots_IranDeal/dscatterPlot_From-hashtagCount.eps}} \\
\end{tabular}
\vspace{-2mm}
