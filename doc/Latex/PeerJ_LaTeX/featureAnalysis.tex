...
\subfloat[Fig:][]{\includegraphics[width=32mm, height=35mm]{images/avgMIBoxPlots/TermVsTopics.pdf}}
\subfloat[Fig:][]{\includegraphics[width=32mm, height=35mm]{images/avgMIBoxPlots/LocationVsTopics.pdf}}
\subfloat[Fig:][]{\includegraphics[width=32mm, height=35mm]{images/avgMIBoxPlots/HashtagVsTopics.pdf}}
\subfloat[Fig:][]{\includegraphics[width=32mm, height=35mm]{images/avgMIBoxPlots/MentionVsTopics.pdf}}
\subfloat[Fig:][]{\includegraphics[width=32mm, height=35mm]{images/avgMIBoxPlots/FromVsTopics.pdf}} \\
\end{tabular}
%\vspace{-2mm}
...
\subfloat[Fig:][]{\includegraphics[width=30mm]{images/ViolinPlots/From-favoriteCount.eps}}
\subfloat[Fig:][]{\includegraphics[width=30mm]{images/ViolinPlots/From-followersCount.eps}}
\subfloat[Fig:][]{\includegraphics[width=30mm]{images/ViolinPlots/From-friendsCount.eps}}
\subfloat[Fig:][]{\includegraphics[width=30mm]{images/ViolinPlots/From-hashtagCount.eps}}
\subfloat[Fig:][]{\includegraphics[width=30mm]{images/ViolinPlots/From-tweetCount.eps}} \\
%\vspace{-10mm}
\subfloat[Fig:][]{\includegraphics[width=30mm]{images/ViolinPlots/Hashtag-tweetCount.eps}}
\subfloat[Fig:][]{\includegraphics[width=30mm]{images/ViolinPlots/Hashtag-userCount.eps}}
\subfloat[Fig:][]{\includegraphics[width=30mm]{images/ViolinPlots/Location-userCount.eps}}
\subfloat[Fig:][]{\includegraphics[width=30mm]{images/ViolinPlots/Mention-tweetCount.eps}}
\subfloat[Fig:][]{\includegraphics[width=30mm]{images/ViolinPlots/Term-tweetCount.eps}} \\
\end{tabular}
\end{tabular}
%\vspace{-2mm}
...
\subfloat[Fig:][]{\includegraphics[width=36mm]{images/DensityPlots_IranDeal/dscatterPlot_From-favoriteCount.eps}} \quad
\subfloat[Fig:][]{\includegraphics[width=36mm]{images/DensityPlots_IranDeal/dscatterPlot_From-followersCount.eps}} \quad
\subfloat[Fig:][]{\includegraphics[width=36mm]{images/DensityPlots_IranDeal/dscatterPlot_From-friendsCount.eps}} \quad
\subfloat[Fig:][]{\includegraphics[width=36mm]{images/DensityPlots_IranDeal/dscatterPlot_From-hashtagCount.eps}} \\
\end{tabular}
\vspace{-2mm}
...
\textbf{Term} & affected & medical & iranian & protest & america & killed & mandela & cimperdible & djokovic & manchester \\ \hline
