...
and in this section we survey four broadly related areas of active research:
(1) trending topic detection, (2) tweet recommendation, (3) friend
sensors, (4) and specific event detection such as earthquake or
influenza sensors and we end the section with discussion of closely related research on tracking general topics.
...
\vspace{2mm}
%\noindent {\bf Trending Topic Detection} 
\subsection*{Trending Topic Detection} represents one of the most popular
...
%\noindent {\bf Tweet Recommendation} 
...
\vspace{2mm}
\subsection*{Specific Event Detection} builds social sensors
