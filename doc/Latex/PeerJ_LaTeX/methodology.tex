...
As noted in Sec.~\hyperref[sec:datasetStatistics]{Data Description}, positively occurring
...
Sec.~\hyperref[sec:lss]{Learning Topical Social Sensors} and our candidate feature set \textit{CF} defined
...
as defined in Sec.~\hyperref[sec:lss]{Learning Topical Social Sensors}.  In this paper, we experiment with
...
As outlined in Sec~\hyperref[sec:lss]{Learning Topical Social Sensors}, tuning of hyperparameters on a validation
