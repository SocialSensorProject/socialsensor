 ...
 * <p>
 * This class provides a dedicated map from integers to floats with a much
 ...
 * @since 2.0
 */
public class OpenIntToFloatHashMap implements Serializable {
     ...
     */
    public OpenIntToFloatHashMap() {
        this(DEFAULT_EXPECTED_SIZE, Float.NaN);
    }
     ...
     */
    public OpenIntToFloatHashMap(final float missingEntries) {
     ...
     */
    public OpenIntToFloatHashMap(final int expectedSize) {
        this(expectedSize, Float.NaN);
    }
     ...
     */
    public OpenIntToFloatHashMap(final OpenIntToFloatHashMap source) {
