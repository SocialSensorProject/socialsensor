...
public class LearningBaseline {
    ...
    private static boolean allInnerJoin = false;

    public static void loadConfig() throws IOException {
        configRead = new ConfigRead();
    }

    public LearningBaseline(String _outputPath, String _dataPath, int _groupNum, long[] _timestamps, int _numPart, String[] _groupNames) throws IOException {
        loadConfig();
