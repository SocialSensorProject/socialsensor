 ...
 * identify the hashtag birthday for each user from the preprocessed data.
 * 
 * @author rbouadjenek
 */
public class HashtagBirthdayPerUser {
    ...
    public static void main(String[] args) throws Exception {
        ...
        JobConf conf = new JobConf(HashtagBirthdayPerUser.class);
        conf.setJobName("Identifying hashtags birthday per users");
        conf.setMapOutputKeyClass(Text.class);
        conf.setMapOutputValueClass(Text.class);
        conf.setOutputKeyClass(Text.class);
        conf.setOutputValueClass(Text.class);
        conf.setMapperClass(HashtagBirthdayPerUser.Map.class);
        conf.setCombinerClass(HashtagBirthdayPerUser.Reduce.class);
        conf.setReducerClass(HashtagBirthdayPerUser.Reduce.class);
