...
public class Regex {
    ...
    /**
     * Allow URL paths to contain up to two nested levels of balanced parens 1.
     * Used in Wikipedia URLs like /Primer_(film) 2. Used in IIS sessions like
     * /S(dfd346)/ 3. Used in Rdio URLs like
  ...
  *
    ...
    /**
     * Valid end-of-path characters (so /foo. does not gobble the period). 2.
  ...
  *
     ...
     *
     * This regex does not reflect its name and
     * {@link Regex#VALID_URL_GROUP_URL} match should be checked in order to
     * match a valid url. This is not ideal, but the behavior is being kept to
     * ensure backwards compatibility. Ideally this regex should be implemented
     * with a negative lookbehind as opposed to a negated character class but
     * lack of JS support increases maint overhead if the logic is different by
     * platform.
     */
